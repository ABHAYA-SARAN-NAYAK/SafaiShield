  ...
  return (
    <div className="screen-flash rounded-2xl p-6 border-2 border-danger">
      <div className="text-center space-y-4">
        ...
        {/* CALL 14473 NOW — pulsing red button, fills bottom half */}
        <a
          href="tel:14473"
          className="w-full min-h-[80px] flex items-center justify-center gap-3
                     bg-danger text-white font-extrabold text-lg rounded-2xl
                     animate-pulse shadow-lg shadow-danger/50
                     no-underline hover:bg-red-700 transition-all"
